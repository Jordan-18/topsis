                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="mahasiswa" class="form-label sm">B.Dsn</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="mahasiswa" class="form-label sm">B.Mhs</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="mahasiswa" class="form-label sm">B.Mt</label>
        ...
        for(var i=0; i < row_al; i++){
            ...
            $('#row_nilai_dosen').append(`
                    <div class="input_nilai mb-3">
                        ...
                        <input type="number" class="form-control" id="nilai_dosen_alternatif${i+1}" name="nilai_dosen_alternatif${i+1}" placeholder="Nilai ${i+1}" required>
                    </div>
            `)
